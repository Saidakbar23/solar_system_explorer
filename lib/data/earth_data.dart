const List<String> information = [
  ...
  'With an equatorial diameter of 7926 miles (12,760 kilometers), Earth is the biggest of the terrestrial planets and the fifth largest planet in our solar system. Earth is about 93 million miles away from the Sun. It takes about eight minutes for light from the Sun to reach our planet.',
...
const List images = [
  ...
  'images/earth_gallery/earth2.jpeg',
  'images/earth_gallery/earth3.jpeg',
