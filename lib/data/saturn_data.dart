const List<String> information = [
  ...
  'Saturn\'s environment is not conducive to life as we know it. The temperatures, pressures, and materials that characterize this planet are most likely too extreme and volatile for organisms to adapt to. The same is not true of some of its many moons. Satellites like Enceladus and Titan, home to internal oceans, could possibly support life.',
  ...
  'ike Jupiter, Saturn is made mostly of hydrogen and helium. At Saturn\'s center is a dense core of metals like iron and nickel surrounded by rocky material and other compounds solidified by intense pressure and heat. It is enveloped by liquid metallic hydrogen inside a layer of liquid hydrogen –similar to Jupiter\'s core but considerably smaller.',
...
const List images = [
  ...
  'images/saturn_gallery/saturn2.jpeg',
  'images/saturn_gallery/saturn3.jpeg',
  'images/saturn_gallery/saturn4.jpeg',
];
